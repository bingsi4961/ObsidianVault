...
| 回合  | 比較     | 計算     | 結果  | 判斷  | 目前陣列             |
| --- | ------ | ------ | --- | --- | ---------------- |
| 1   | 3 vs 1 | 3-1=2  | 正數  | 1在前 | `[1, 3, 4, 2]`   |
| 2   | 3 vs 4 | 3-4=-1 | 負數  | 3在前 | `[1, 3, 4, 2]`   |
| 3   | 4 vs 2 | 4-2=2  | 正數  | 2在前 | `[1, 3, 2, 4]`   |
| 4   | 3 vs 2 | 3-2=1  | 正數  | 2在前 | `[1, 2, 3, 4]`   |
| 5   | 1 vs 2 | 1-2=-1 | 負數  | 1在前 | `[1, 2, 3, 4]` ✓ |
|     |        |        |     |     |                  |
...
這份整合筆記已經涵蓋了所有核心概念與實務應用，建議您把「快速查詢表」那段背起來，實際開發就夠用了!